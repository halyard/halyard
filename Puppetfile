...
github "git",         "2.5.0"
github "osx",         "2.7.1"
github "osxoptions",  "0.0.1", :repo => "halyard/puppet-osxoptions"
...
github "fdesetup",    "0.0.1", :repo => "halyard/puppet-fdesetup"
github "dotdotdot",   "0.0.1", :repo => "halyard/puppet-dotdotdot"
